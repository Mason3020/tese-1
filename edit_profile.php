<?php
	...
	if (isset($_GET['user_id'])) {
        ...
        while($details=$user_details->fetch_array()) {
	...
	if (isset($_POST['register'])) {
		...
		if ($add_user == 0) {
			echo "<script>alert('Failed Updating Your Profile')</script>";
		} else {
  ...
  <nav class="navbar">
	...
	<h2 style="text-align: center;">Edit Profile</h2>
	  ...
	  <div class="form-group">
	    ...
	    <div class="col-sm-8"> 
	      <input type="cost" class="form-control" id="firstname" name="firstname" value="<?php echo $firstname;?>" required="">
	    </div>
	  </div>
	  ...
	  <div class="form-group">
	    ...
	    <div class="col-sm-8"> 
	      <input type="cost" class="form-control" id="surname" name="surname" value="<?php echo $surname;?>" required="">
	    </div>
	  </div>
	  ...
	  <div class="form-group"> 
	    <div class="col-sm-offset-5 col-sm-12">
	      <button type="submit" class="btn btn-default" name="register">Update Profile</button>
	    </div>
	  </div>
